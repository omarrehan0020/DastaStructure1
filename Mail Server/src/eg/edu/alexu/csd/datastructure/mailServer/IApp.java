...
public interface IApp {
	...
	* @return false if the email name not exist
	 ...
	 * @throws IOException 
	*/
	public boolean signin(String email, String password) throws FileNotFoundException, IOException;
	/**
	* Create new account
	* @param contact
...
//	public void setViewingOptions(IFolder folder, IFilter filter, ISort sort);
	/**
	* You should use setViewingOptions function first* @param page to handle paging
